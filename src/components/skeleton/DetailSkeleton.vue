<template>
    <div>
        <div class="animate-pulse mb-5 space-y-2">
            <div class="h-6 w-full sm:w-1/2 bg-gray-200 rounded dark:bg-dark-700"></div>
            <div class="h-3 w-3/4 sm:w-1/4 bg-gray-200 rounded dark:bg-dark-700"></div>
        </div>
        <div class="mb-9">
            <div class="flex justify-between mb-2 animate-pulse">
                <div class="h-4 w-1/4 bg-gray-200 rounded dark:bg-dark-700"></div>
                <div class="h-4 w-1/4 bg-gray-200 rounded dark:bg-dark-700"></div>
            </div>
                    ...
                    <div class="px-6 py-4 shadow-md border border-gray-100
                        ...
                        <div class="flex flex-col items-center space-y-4 w-44">
                            <div class="flex justify-between w-full">
                                <div class="h-4 w-1/3 bg-gray-200 rounded dark:bg-dark-700"></div>
                                <div class="h-4 w-1/3 bg-gray-200 rounded dark:bg-dark-700"></div>
                            </div>
                    ...
                    <div class="px-6 py-4 shadow-md border border-gray-100
                        ...
                        <div class="flex flex-col items-center space-y-4">
                            ...
                            <div class="flex justify-between items-end w-full">
                                ...
                                <div class="w-10">
                                    <div class="h-6 w-full bg-gray-200 rounded
                                        dark:bg-dark-700"></div>
                                </div>
                            </div>
                        </div>
